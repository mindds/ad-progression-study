...
fwrite(trends_gene, "temporal_gene_sets.csv")

```

# Pathway analysis: Pathways analysis was done on gsea and the excel files were generated with overalapping genes to choose the pathwyas for plotting - performed on the file  ~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Scripts/TP_pathways_barplots.Rmd
...
ggsave(bars, filename = file.path(rdir,  "TP_barplots", "all_bars_TP.png"), width = 15, height = 30, units = "in")
