...
```{r}
load(file.path("../Data/Fig4_data/ast_sample.level.average.expression_filtered.Rdata"))
...
p4vsp3 = fread(file.path("../Data/Fig4_data/P4vsP3.csv"))
p3vsp2 = fread(file.path("../Data/Fig4_data/P3vsP2.csv"))
p2vsp1 = fread(file.path("../Data/Fig4_data/P2vsP1.csv"))
...
ggsave(bars, filename = file.path(rdir,  "Fig4", "all_bars_TP.png"), width = 15, height = 30, units = "in")
