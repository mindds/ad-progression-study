...
fwrite(region_de, file.path(rdir, "ast_ctrl_de_01042022.csv"))
```


```{r}
#load the file
path1_de = fread(file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Data/ast_ctrl_de_01042022.csv"))
```
...
#ggsave (filename = file.path(p_dir,"Figure2a.png"), height = 3, width = 6)
```
...
#Question was this filtered manually? 
...
path1_region_up_gs = read.xlsx(
  file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Data/ast_ctrl_region_de_summary_with.all.regions_asp_filtered.xlsx"),
  sheet = "up genes") %>%
  setDT() %>%
  .[, .(cluster, gene)]
...
fig2b_up
png(file.path(p_dir, "fig2b_up_heatmap.png"),
...
png(file.path(p_dir, "fig2b_down_heatmap.png"),
    width = 300, height = 1300)
draw(fig2b_down)
dev.off()
```
...
dt = fread(file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Data/Fig2_data/mast_allregion_ast_sampled_path1_ptau_06022022_modeldt_ctrl_f12.csv"))
...
# ggsave(fig2d_P1,filename = "~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Results/Figure_2/fig2d.png", height = 4)
```
...
```{r}
path1_de = fread(file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Data/Fig2_data/ast_ctrl_de_01042022.csv"))
# load pTau genes
# venn diagram
...
# load 
dt_f = file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Data/Fig2_data/mast_allregion_ast_sampled_path1_ptau_06022022_modeldt_ctrl_f12.csv")
...
png(
  file.path(p_dir, "fig2e_venn_path1_poscorr&echigh_adjp_0614022.png"),
  width = 300,
  height = 300
)
figure_2ea<- do_fig2e(
...
ggsave ("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Results/Figure_2/Figure_2ea.png")
...
ggsave ("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Results/Figure_2/Figure_2eb.png")
