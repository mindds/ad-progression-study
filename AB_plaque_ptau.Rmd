...
The following scripts are used to generate figue 1d
...
meta = fread(file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Data/Fig1_data/Abbvie_AD_progression_meta.csv"))
...
ggsave(file.path("~/Dropbox (Partners HealthCare)/Abbvie collaboration/Astrocytes scripts/Results/Figure_1/fig1d.png"),
       fig1d, height = 4, width = 8)
# ggsave(file.path(p_dir, "fig1d.svg"),
#        fig1d, height = 6, width = 9)
```
This chunk is for Fig S2
...
fig1d_2 = ggarrange(fig1d_abeta_2, fig1d_ptau_2,
          nrow = 2, ncol = 1)
# ggsave(file.path(p_dir, "Figure_1", "fig1d_facet.by.brain.regions.png"),
