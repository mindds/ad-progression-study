...
load("/space/mindds_001/projects/AbbvieSnRNASeq/data/Rdata/ast_all.brain.regions_cluster.group_removed.Rdata")
...
Fig 3a, b - run locally



```{r}
load(file = file.path(data_dir, "Fig3_data", "pathall_clust.RData"))
...
p_line
ggsave(file.path(rdir, "Fig3", "fig3a-gene-trajectories.png"), width = 5, height = 6)
...
Pathways analysis was done on gsea web tool https://www.gsea-msigdb.org/gsea/msigdb/annotate.jsp  and the .csv files were generated. Selected pathways were plotted in Fig 3b
...
allcluster <- fread("../Data/Fig3_data/allclusters_SP_asp.csv")
...
bars = ggarrange(bar_1, bar_2, bar_3, bar_4, bar_5, bar_6, 
          ncol = 1, align = "hv")
bars
ggsave(bars, filename = file.path(rdir,  "Fig3", "all_bars_SP.png"), width = 15, height = 30)
